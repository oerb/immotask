...
STATIC_ROOT = os.path.join(ROOT_PATH, 'Immotask/static')
...
ROOT_URLCONF = 'Immotask.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Immotask.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS=(
        ...
        # my custom_processor
        "Immotask.custom_processors.menulist",
        "Immotask.custom_processors.level2menulist",
        "Immotask.custom_processors.metainfos_blogname",
