...
class Setting(models.Model):
    ...
    """
    se_current_proj = models.ForeignKey(Project, related_name=u'current Project ID', blank=True, null=True)
    ...
    se_address = models.ForeignKey(Address, blank=True, null=True)